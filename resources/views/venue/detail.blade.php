            ...
            <div class="offset-md-3 col-md-6">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"> Detail Venue</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
